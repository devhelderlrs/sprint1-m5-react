...
export function ParagrafoApp(props) {
  return (
    <section className="paragrafo-app">
...
export function ParagrafoEmail(props) {
  return (
    <section className="paragrafo-email">
      <h3>Olá, Cliente!</h3>
      <p>
        Fizemos uma lista especial de produtos apenas para você. Isso mesmo:
        nesta lista temos só produtos que você pode gostar. Seus amigos lhe
        recomendaram essa lista especial. Olha só:
      </p>
    </section>
  );
}
